...
// Define SnippetModel type which wraps the sql.DB
type SnippetModel struct {
	DB *sql.DB
}

// Insert will inset a new snippet into database
...
// Get will retrive a snippet from the database
...
// Latest return the 10 most recently added snippet
